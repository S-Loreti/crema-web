...
const Guide = () => {
    ...
    <div style={{ fontFamily: 'Arial, sans-serif', maxWidth: '1200px', margin: '0 auto', padding: '20px', backgroundColor: '#f8f8f8', boxShadow: '0px 0px 20px rgba(0, 0, 0, 0.1)' }}>    
           <div id="scones" style={{ marginTop: '30px', padding: '30px', backgroundColor: '#ffffff', borderRadius: '10px' }}>
            ...
            <div id="680" style={{ marginTop: '30px', padding: '30px', backgroundColor: '#ffffff', borderRadius: '10px' }}>
